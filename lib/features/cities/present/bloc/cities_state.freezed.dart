...
mixin _$CitiesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int? selectedCityId) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int? selectedCityId)? loaded,
...
class _$loadedImpl implements _loaded {
  const _$loadedImpl({required this.selectedCityId});
  ...
  @override
  String toString() {
    return 'CitiesState.loaded(selectedCityId: $selectedCityId)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(selectedCityId);
  }
...
abstract class _loaded implements CitiesState {
  const factory _loaded({required final int? selectedCityId}) = _$loadedImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'CitiesState.failure(error: $error)';
  }
